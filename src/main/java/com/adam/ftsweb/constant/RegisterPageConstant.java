...
public class RegisterPageConstant {
    ...
    public static final String NICKNAME_INPUT_BLANK = "昵称输入为空";
    public static final String NICKNAME_LENGTH_EXCEEDED = "昵称长度不能超过32个字符";
    ...
    public static final String BIRTHDATE_INVALID = "出生日期格式错误";
    public static final String HOBBY_LENGTH_EXCEEDED = "爱好不能超过100个字符";
    public static final String AUTOGRAPH_LENGTH_EXCEEDED = "个性签名不能超过100个字符";
